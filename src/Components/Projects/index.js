        ...
        return (
            <div id='projects' className="section__projects">
                ...
                <div className='projects-top'>
                    <h3 className='projects-title'>Data Analytics / Machine Learning</h3>
                    <div className='projects-category'>
                        ...
                        <div className='data-project card'>
                            <div className='front student-img'>
                                <h4>Student Performance Analysis</h4>
                            </div>
                            <div className='back'>
                                <p>&rarr; Technologies used: Python (Pandas, Seaborn) <br/>
                                &rarr; Exploratory and regression analysis with Python libraries</p>
                                <p className='link-center'>
                                    <a href='https://github.com/guiOsorio/Student-Analysis' target='_blank'>Github repository</a>
                                </p>
                                <p className='link-center'>
                                    <a href='/student'>Project's page</a>
                                </p> 
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='projects-category'>
                        ...
                        <div className='webdev-project card'>
                            ...
                            <div className='back'>
                                ...
                                <p className='link-center'>
                                    <a href='https://github.com/usd-cs/acm-website' target='_blank' className='link-other'>Github repository</a> 
                                </p>
                                <p className='link-center'>
